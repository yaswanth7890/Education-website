...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "4d3a4bb9-d173-4974-a35e-18b0a5cd86d6");
    ...
    <div className='contact'>
        <div className="contact-col">
         ...
         <ul>
            ...
            <li> <img src={location_icon} alt="" />77 Masachusetts Ave, Cambridge <br/> MA 03129 ,United States </li>
         </ul>
        </div>
        <div className="contact-col">
